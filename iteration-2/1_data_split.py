...
train.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\train.jsonl', orient='records', lines = True)
dev.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\dev_seen.jsonl', orient='records', lines = True)
test.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\test_seen.jsonl', orient='records', lines = True)

train = pd.read_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\train.jsonl', lines = True)
dev = pd.read_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\dev_seen.jsonl', lines = True)
test = pd.read_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\test_seen.jsonl', lines =  True)

test_seen = test[0:54].reset_index(drop = True)
test_unseen = test[55:].reset_index(drop = True)

val_seen = val[0:35].reset_index(drop = True)
val_unseen = val[36:].reset_index(drop = True)

val_seen.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\dev_seen.jsonl')
val_unseen.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\dev_unseen.jsonl')

test_seen.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\test_seen.jsonl', orient='records', lines = True)
test_unseen.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\test_unseen.jsonl', orient='records', lines = True)

train.to_json('C:\\Users\\richa\\OneDrive\\Documenten\\GitHub\\master_thesis_2022\\iteration-2\\data\\train.jsonl')
